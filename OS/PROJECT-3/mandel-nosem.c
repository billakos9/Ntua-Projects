...
// 2d array to hold the color values for each point
int **buffer;
...
void compute_and_output_mandel_line(int i_PROC, int **buffer ){
...
int main(int argc, char *argv[]){
        ...
        for(int i=0; i<NPROCS; i++) {
                ...
                if(p[i]<0) {
                        ...
                        compute_and_output_mandel_line(i, buffer);
                        exit(0);
                }
        }
        ...
        destroy_shared_memory_area(buffer, y_chars * sizeof(int));
